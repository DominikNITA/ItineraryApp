...
interface IRandomStationNamesService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
    getRandomStationNames: IRandomStationNamesService_IGetRandomStationNames;
}

interface IRandomStationNamesService_IGetRandomStationNames extends grpc.MethodDefinition<users_pb.RandomStationNamesRequest, users_pb.StationNames> {
    path: "/users.RandomStationNames/GetRandomStationNames";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<users_pb.RandomStationNamesRequest>;
    requestDeserialize: grpc.deserialize<users_pb.RandomStationNamesRequest>;
    responseSerialize: grpc.serialize<users_pb.StationNames>;
    responseDeserialize: grpc.deserialize<users_pb.StationNames>;
}

export const RandomStationNamesService: IRandomStationNamesService;

export interface IRandomStationNamesServer {
    getRandomStationNames: grpc.handleUnaryCall<users_pb.RandomStationNamesRequest, users_pb.StationNames>;
}

export interface IRandomStationNamesClient {
    getRandomStationNames(request: users_pb.RandomStationNamesRequest, callback: (error: grpc.ServiceError | null, response: users_pb.StationNames) => void): grpc.ClientUnaryCall;
    getRandomStationNames(request: users_pb.RandomStationNamesRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: users_pb.StationNames) => void): grpc.ClientUnaryCall;
    getRandomStationNames(request: users_pb.RandomStationNamesRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: users_pb.StationNames) => void): grpc.ClientUnaryCall;
}

export class RandomStationNamesClient extends grpc.Client implements IRandomStationNamesClient {
    constructor(address: string, credentials: grpc.ChannelCredentials, options?: object);
    public getRandomStationNames(request: users_pb.RandomStationNamesRequest, callback: (error: grpc.ServiceError | null, response: users_pb.StationNames) => void): grpc.ClientUnaryCall;
    public getRandomStationNames(request: users_pb.RandomStationNamesRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: users_pb.StationNames) => void): grpc.ClientUnaryCall;
    public getRandomStationNames(request: users_pb.RandomStationNamesRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: users_pb.StationNames) => void): grpc.ClientUnaryCall;
}
